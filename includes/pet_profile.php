...
$id_cust = $row['id_cust'];
?>
<input type="hidden" class="form-control" id="id_cust" name="id_cust" value="<?php echo $id_cust; ?>" autofocus autocomplete="off" readonly>
<?php
}
}
...
<div class="col-sm-9">
<input type="text" class="form-control" id="pet_name" name="pet_name" autocomplete="off" required>
</div>
</div>
<div class="form-group">
