...
<?php
	...
	if(isset($_POST['add'])){
		...
		$conn = $pdo->open();
			...
			try{
				$stmt = $conn->prepare("INSERT INTO wastage (id_products, category, price, stocks, expired_date, batch_number, reason, qty) VALUES (:product, :category, :price, :stocks, :expired_date, :batch_number, :reason, :qty)");
				...
				$_SESSION['success'] = 'Wastage added successfully';
			}
		...
		$_SESSION['error'] = 'Fill up wastage form first';
	}
