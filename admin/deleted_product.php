        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="products.php"><button class='btn btn-primary btn-sm btn-flat'><i class="fa fa-arrow-left"></i> Back</button></a>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control input-sm" id="select_category">
                      ...
                      <?php
                        ...
                        $stmt = $conn->prepare("SELECT * FROM category where type != 'Services' order by category asc");
                        $stmt->execute();
              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    try{
                      $now = date('Y-m-d');
                      $stmt = $conn->prepare("SELECT * FROM products $where where deleted_date != '0000-00-00' order by name asc");
                      $stmt->execute();
                      foreach($stmt as $row){
                        ...
                        echo "
                          <tr>
                            ...
                            <td>
                              <button class='btn btn-primary btn-sm restore btn-flat' data-id='".$row['id_products']."'><i class='fa fa-recycle'></i> Restore</button>
                            </td>
                          </tr>
                        ";
                      }
