...
"<div class='notification-subject'><b>". $rows['name']. " (Batch ". $batch. ")</b> is out of stock.</div><hr>" . 
"</div>";
}
else{
echo "<div class='notification-item' style='color:white'>" .
"<div class='notification-subject'><b>". $rows['name']. " (Batch ". $batch. ")</b> is running out of stock.</div><hr>" . 
"</div>";
}
}
}
