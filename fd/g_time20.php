...
$conn = $pdo->open();
if(isset($_GET['id_services20'])){
$id_services20 = $_GET['id_services20'];
$stmt = $conn->prepare("SELECT * FROM services WHERE id_services='$id_services20'");
$stmt->execute();
...
<label for="edit_name" class="col-sm-3 control-label" id="gtime20">TIME</label>
<div class="col-sm-8">
<select class="form-control" id="gtime220" name="time_reservation" required>
