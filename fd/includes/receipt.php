...
<div class="col-sm-2">
<input type="text" class="form-control total" name="total" autocomplete="off" style="background-color:white; border-color:white; font-size:18px; color:#009900; font-weight:bold; margin-top:2px;" readonly>
</div>
<label for="name" class="col-sm-9 control-label" style="font-size:18px">AMOUNT PAID:</label>
<label for="name" class="col-sm-1 control-label" style="font-size:18px">&#8369;</label>
<div class="col-sm-2">
<input type="text" class="form-control amount_paid" name="amount_paid" autocomplete="off" style="background-color:white; border-color:white; font-size:18px; color:#009900; font-weight:bold; margin-top:2px;" readonly><hr />
</div>
<label for="name" class="col-sm-9 control-label" style="font-size:18px">CHANGE:</label>
<label for="name" class="col-sm-1 control-label" style="font-size:18px">&#8369;</label>
<div class="col-sm-2">
<input type="text" class="form-control sukli" name="sukli" autocomplete="off" style="background-color:white; border-color:white; font-size:18px; color:#009900; font-weight:bold; margin-top:2px;" readonly>
</div>
</div>
</div>
</div>
...
<button type="submit" class="btn btn-success btn-flat" name="add"><i class="fa fa-file-pdf-o"></i> View as PDF</button>
<button id="btnPrint" type="button" class="btn btn-success btn-flat"><i class="fa fa-print"></i> Print</button>
</div>
</form>
</div>
</div>
