            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="suppliers_add.php" enctype="multipart/form-data">
			    <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="company" name="company" autofocus autocomplete="off" maxlength="50" min="2" required>
                    </div>
                </div>
				<div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="cperson" name="cperson" autocomplete="off" maxlength="50" min="2" required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="cnumber" name="cnumber" autocomplete="off" maxlength="11" min="8" required>
                    </div>
                </div>
            </div>
