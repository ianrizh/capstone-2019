...
<div class="form-group">
<label for="price" class="col-sm-3 control-label">Current Stock</label>

<div class="col-sm-9">
<input type="text" class="form-control" id="total_stocks" name="total_stocks" readonly required>
</div>
</div>
...
<input type="date" class="form-control" name="expired_date" id="expdate"/><br>
<input type="checkbox" onClick="toggleTB(this)" id="expdate1" name="expired_date" value="No Expiration Date" <?php if(isset($_POST['expired_date'])) echo 'checked="No Expiration Date"'; ?>>No Expiration Date
</div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal">
                <input type="text" class="id_stocks_expired" name="id_stocks_expired" />
				<div class="form-group">
					<div class="col-sm-11">
