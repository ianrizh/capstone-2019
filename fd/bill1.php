...
<div class="col-sm-4">
<input type="text" class="form-control" name="name" autocomplete="off" style="background-color:white; border-color:white" value="<?php echo "$pname (&#8369; ".number_format($pprice,2).")"; ?>" readonly>
</div>
...
<div class="col-sm-6">
<input type="text" class="form-control" value="<?php echo "&#8369; ".number_format($total,2).""; ?>" id="total" name="total" style="background-color:white; border-color:white; color:#009900; font-weight:bold; text-align:right" onKeyUp="calc(this)" readonly>
</div>
</div>
<div class="form-group">
<label for="name" class="col-sm-6 control-label">CASH:</label>
<div class="col-sm-6">
<input type="text" class="form-control" value="<?php echo "&#8369; ".number_format($amount_paid,2).""; ?>" id="_change" name="_change" style="background-color:white; border-color:white; color:#009900; font-weight:bold; text-align:right" value="0.00" autocomplete="off" readonly>
</div>
</div>
<div class="form-group">
<label for="name" class="col-sm-6 control-label">CHANGE:</label>
<div class="col-sm-6">
<input type="text" class="form-control" value="<?php echo "&#8369; ".number_format($_change,2).""; ?>" id="_change" name="_change" style="background-color:white; border-color:white; color:#009900; font-weight:bold; text-align:right" value="0.00" autocomplete="off" readonly>
</div>
</div>
