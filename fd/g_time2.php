...
$conn = $pdo->open();
if(isset($_GET['id_services2'])){
$id_services2 = $_GET['id_services2'];
$stmt = $conn->prepare("SELECT * FROM services WHERE id_services='$id_services2'");
$stmt->execute();
...
<label for="edit_name" class="col-sm-3 control-label" id="gtime2">TIME</label>
<div class="col-sm-8">
<select class="form-control" id="gtime22" name="time_reservation" required>
