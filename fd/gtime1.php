...
$conn = $pdo->open();
if(isset($_GET['id_services1'])){
$id_services1 = $_GET['id_services1'];
...
<select ng-model="addData.time_reservation" class="form-control" id="gtime1" ng-required="true">
...
<select ng-model="addData.time_reservation" class="form-control" id="gtime1" required>
<option value="" disabled selected required>---Select---</option>';
$stmt = $conn->prepare("select * from type where type = 'Services'");
$stmt->execute();
foreach($stmt as $r){
