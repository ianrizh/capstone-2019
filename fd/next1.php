...
<div class="tab">
<button class="tablinks" onClick="openTab(event, 'tab_orders')" id="defaultOpen">NEW PET</button>
<button class="tablinks" onClick="openTab(event, 'tab_services')">OLD PET</button>
</div>
...
<div class="box">
<div class="box-body" id="service2">	
<div class='box-header'>
<h3 class='box-title' style='color:#36bbbe;'><b><i class='fa fa-paw'></i> NEW PET DETAILS</b></h3>
</div>  
...
$http({
method:"GET",
url:"select2.php?id_cust="+id_cust,
...
<!--<button type="submit" class="btn btn-success btn-sm btn-flat" id="btn_confirmorder" style="width: 100%; margin-top:30px;"><i class="fa fa-send"></i> Submit</button>-->
</div> 
</div>
</div>
<!-- ORDERS -->
...
<div class="box" style="margin-top: -235px;">
<div class="box-body">
<form method="post">
<div class='box-header'>
<h3 class='box-title' style='color:#36bbbe;'><b><i class='fa fa-paw'></i> OLD PET DETAILS</b></h3>
</div>
<div class="form-group">
<label for="edit_name" class="col-sm-3 control-label" style="text-align: right">PET NAME</label>
<div class="col-sm-8">
<select class="form-control select2" id="id_pet" name="id_pet" onChange="onSelect3(this.value)" style="width:100%;" required>
<option value="" disabled selected required>---Select---</option>
<?php 
$conn = $pdo->open();
try{
$stmt = $conn->prepare("SELECT * FROM pets WHERE id_cust='$customer'");
$stmt->execute();
