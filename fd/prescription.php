...
<h4 class="modal-title"><b>Prescription</b></h4>
...
<tbody>
<?php
$stmt = $conn->prepare("select * from reservation where status = 'Process Done' and reservation_id = :bill or status = 'Paid' and reservation_id = :bill");
$stmt->execute(['bill' => $bill]);
foreach($stmt as $r){		
