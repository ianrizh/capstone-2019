...
<div class="register-box" style="margin-bottom:110px; margin-top:100px; padding:10px;">
    ...
    ?>
  	<div class="register-box-body">
    	...
    	<p class="login-box-msg" style="font-size:20px; font-weight:bold;">WELCOME TO <br>STELLA'S ANIMAL CLINIC</p>
          ...
          <div class="form-group has-feedback">
			...
			<p>
    			<div class="col-xs-4" style="width:100%">
          			<button type="submit" class="btn btn-primary btn-block btn-flat" style="width:100%; background-image: linear-gradient(to right, rgb(54,187,190), rgb(239,183,78)); border:none;" name="login"><i class="fa fa-sign-in"></i> Sign In</button>
        		</div>
      		</div>
    	</form>
      <br><br><br><br><br>
