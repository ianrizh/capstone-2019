...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 17, 2019 at 08:39 AM
...
(1, 1, 0, '2019-08-12', '02:00 p.m - 02:30 p.m', 'hatdog', 'pootlong', 3, 1, 50.00, 300.00, 500.00, 200.00, '2019-08-17', 'Paid', '2019-08-17');
...
INSERT INTO `online_reservation1` (`reservation_id`, `user_pets_id`, `id_services`, `thedate`, `time_reservation`, `findings`, `prescription`, `products_used`, `qty`, `prod_price`, `total`, `cash`, `_change`, `pay_date`, `status`, `process_done`) VALUES
(1, 4, 7, '2019-08-13', '10:30 a.m - 12:00 p.m', 'lagnat', 'biogesic', 7, 1, 800.00, 1150.00, 1500.00, 350.00, '2019-08-17', 'Paid', '2019-08-17');
