...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 11, 2019 at 02:51 AM
...
(1, 40, 'Belle', 'Cat', 'Persian', 'Female', '0000-00-00'),
(2, 40, 'Cong', 'Dog', 'Golden Retriever', 'Male', '0000-00-00'),
(3, 40, 'Paw', 'Cat', 'American Curl', 'Female', '0000-00-00'),
(4, 40, 'Yoh', 'Dog', 'Cornish Rex', 'Male', '0000-00-00'),
(5, 40, 'Vien', 'Cat', 'Siamese', 'Female', '0000-00-00'),
(7, 40, 'Junjun', 'Cat', 'Siamese', 'Male', '0000-00-00'),
(8, 40, 'Keng', 'Dog', 'Akita', 'Male', '0000-00-00');
...
(1, 1, 'Furmagic 1 Liter', 500.00, 'Furmagic 1 Liter.jpg', 190, '0000-00-00'),
...
(9, 3, 'Mycocide Shampoo', 435.00, 'Mycocide Shampoo.jpg', 96, '0000-00-00'),
...
(1, 1, 1, 4, '2019-10-18', '09:00 a.m', '09:00:00', '00:00:00', 'Online', '400.00', 400.00, 0.00, 0.00, '0000-00-00', 'Process Done', '2019-10-10', NULL, 0);
...
(55, 1, 4, '2022-03-02', 90, '2019-10-06', 0),
...
(1, 'Andrea', 'Capistrano', 'Unit 25 Emeral Complex, P. Tuazon Blvd, Project 4, Quezon City, Metro Manila', 'andrea_capistrano@gmail.com', '09166437127', '$2y$10$kzX3tdd2YUJJgN/9s3gpj.dpmo5G5WTE33HpTjX4OZat6D6Nv3.JG', '', 1, 1, '', ''),
(2, 'Amabelle', 'Capistrano', 'Unit 25 Emeral Complex, P. Tuazon Blvd, Project 4, Quezon City, Metro Manila', 'amabelle_capistrano@gmail.com', '09166437127', '$2y$10$Gj7Qw00Rhqc2mU8Xcrz3VeqPyhcEsF0ObToSTedDf1zM835CEpgwm', '', 2, 1, '', ''),
...
--
ALTER TABLE `pota`
  MODIFY `pota_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
--
...
--
ALTER TABLE `users`
  MODIFY `id_cust` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
...
--
ALTER TABLE `wastage`
  MODIFY `id_wastage` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
