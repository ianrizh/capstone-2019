...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 05, 2019 at 07:11 AM
...
INSERT INTO `online_reservation` (`reservation_id`, `user_pets_id`, `id_services`, `thedate`, `time_reservation`, `findings`, `prescription`, `total`, `pay_date`, `status`, `process_done`) VALUES
(1, 2, 0, '2019-08-15', '10:00 a.m - 10:30 a.m', '', '', 0.00, '0000-00-00', 'Confirm', '0000-00-00 00:00:00'),
(2, 3, 0, '2019-08-21', '11:00 a.m - 11:30 a.m', '', '', 0.00, '0000-00-00', 'Decline', '0000-00-00 00:00:00'),
(3, 1, 0, '2019-08-24', '02:00 p.m - 02:30 p.m', '', '', 0.00, '0000-00-00', 'Reschedule', '0000-00-00 00:00:00'),
(4, 2, 0, '2019-08-13', '05:00 p.m - 05:30 p.m', '', '', 0.00, '0000-00-00', 'Not Confirm', '0000-00-00 00:00:00'),
(5, 2, 0, '2019-08-18', '12:30 p.m - 01:00 p.m', '', '', 0.00, '0000-00-00', 'Confirm', '0000-00-00 00:00:00');
...
ALTER TABLE `online_reservation1`
  ADD PRIMARY KEY (`reservation_id`),
  ADD KEY `reservation_id` (`reservation_id`,`user_pets_id`,`service_id`),
  ADD KEY `user_pets_id` (`user_pets_id`),
  ADD KEY `service_id` (`service_id`);
...
--
ALTER TABLE `user_pets`
  MODIFY `user_pets_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
ALTER TABLE `online_reservation1`
  ...
  ADD CONSTRAINT `online_reservation1_ibfk_2` FOREIGN KEY (`service_id`) REFERENCES `services` (`id_services`);
